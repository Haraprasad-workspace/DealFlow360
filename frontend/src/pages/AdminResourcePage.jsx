...
const AdminResourcePage = ({ resource }) => {
	...
	useEffect(() => { load(); }, [load]);
	useEffect(() => { setForm(config.blank); setEditing(null); }, [config, resource]);
